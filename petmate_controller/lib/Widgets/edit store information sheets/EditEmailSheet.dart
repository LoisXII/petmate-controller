...
class EditEmailSheet extends StatelessWidget {
        ...
        builder: (context, constraints) => Column(
          ...
          children: [
            ...
            Container(
              ...
              child: AutoSizeText(
                MyServices().capitalizeEachWord('update email'),
            ...
            Consumer<LocalFunctionProvider>(
              builder: (context, functions, child) => MyTextFormFieldTemplate(
                ...
                controller: functions.email_controller_update,
                text: MyServices().capitalizeEachWord('new email '),
            ...
            Consumer<FirebaseProvider>(
              builder: (context, firebase, child) =>
                ...
                builder: (context, functions, child) => MyButtonTemplate(
                    ...
                    onPressed: () async {
                      if (functions.email_controller_update.text.isNotEmpty) {
                        // check the email .
                        if (functions.email_controller_update.text
                                    .toLowerCase()
                                    .trim()
                                    .contains("@") ==
                                true &&
                            functions.email_controller_update.text
                                    .toLowerCase()
                                    .trim()
                                    .contains(".com") ==
                                true) {
                          ...
                          // update .
                          await firebase.UpdateTheEmail(
                                  email: functions.email_controller_update.text
                                      .toLowerCase()
                                      .trim())
                              .whenComplete(
                            () {
                              ...
                              MyServices().ShowNotificationSheet(
                                ...
                                message: MyServices().capitalizeEachWord(
                                    'update the email has been done successfully !'),
                                action: () {},
                              );
                            },
                          );
                          ...
                          MyServices().ShowNotificationSheet(
                            ...
                            message: MyServices().capitalizeEachWord(
                                'the email formate is invalid'),
                            action: () {},
                          );
                        }
                      } else {
                        print("the new email textfield is empty ! ");
                      }
                    },
                    style: Theme.of(context).textTheme.headlineLarge!.copyWith(
                          fontWeight: FontWeight.bold,
